...
var ipOrDomainSchema = import_zod4.z.string().refine((value) => ipOrDomainPattern.test(value), {
  message: "Invalid IP or domain format"
});
var ipOrDomainSchema_default = ipOrDomainSchema;
...
var IniConfig = class {
  ...
  getConfigData() {
    ...
    if (result.success)
      return result.data;
    const errorMessage = formatZodError_default(result.error.issues);
...
var ipOrDomainSchema2 = import_zod7.z.string().refine((value) => ipOrDomainPattern2.test(value), {
  message: "Invalid IP or domain format"
});
var proxySchema = import_zod7.z.object({
  type: import_zod7.z.union([import_zod7.z.literal("http"), import_zod7.z.literal("socks")]),
  host: ipOrDomainSchema2,
